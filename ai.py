...
def generate_task(difficulty, subject_admin):
    ...
    if subject_admin == 'информатика':
        ...
        prompt = f"""
            ...
            чтобы он не запутался и не задавал лишних вопросов и сделай ответ однозначным, если ответ не стандартный то напиши подсказку как писать ответ или превиди пример.
            ответ верни строго в формате JSON:
            {{
            'тема': "",
            'название задачи': "",
